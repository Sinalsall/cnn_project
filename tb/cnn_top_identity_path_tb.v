...
module cnn_top_identity_path_tb;
    ...
    initial begin
        $dumpfile("tb/cnn_top_identity_path_tb.vcd");
        $dumpvars(0, cnn_top_identity_path_tb);

        $display("=== CNN TOP IDENTITY-PATH TB START ===");
        ...
        if (error_count == 0) begin
            $display("[TB][PASS] top-level identity-path non-zero test passed.");
        end else begin
